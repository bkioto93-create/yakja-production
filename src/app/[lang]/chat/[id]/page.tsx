...
//
// **به‌روزرسانی فاز ۱۳ (چت با مدیر/پشتیبانی):** پاس‌دادن یک آرگومان تازه
...
// گفتگو به آن اشاره می‌کرد (قدیمی‌ترین حساب ادمین) اجازه‌ی باز کردن این صفحه را داشت؛ هر ادمین
// دیگری با پیام «این گفتگو یافت نشد» مواجه می‌شد، حتی اگر همان گفتگو در فهرست /admin/chats
// دیده می‌شد. حالا آرگومان پنجم (user.role === "admin") هم به getConversationForUser پاس داده
// می‌شود تا هر کاربری که نقش ادمین دارد بتواند گفتگوهای پشتیبانی را ببیند و پاسخ بدهد.
