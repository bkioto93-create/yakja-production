...
export const Icons = {
  ...
  // --- افزوده‌شده جهت دکمه‌ی «حذف عکس پروفایل» در کارت عکس پروفایلِ خودِ کاربر
  ...
  // --- افزوده‌شده جهت کارتِ چهارمِ امتیازِ VIP («استوری طولانی‌تر») در
  // src/app/[lang]/vip/page.tsx و ردیفِ چهارمِ بنرِ VIP در src/components/home/VipHomeBanner.tsx —
  // نمادِ ساعت برای انتقالِ حسِ «زمانِ بیشتر»، هم‌راستا با متنِ همان امتیاز. ---
