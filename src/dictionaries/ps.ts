...
export default {
  ...
  "home": {
    ...
    "slogan": "پیرودل، پلورل، لیږدونه او فني خدمتونه. د افغانستان ټولو هېوادوالو لپاره یوه عصري، خوندي او بې واسطې تجربه.",
    "trustBadges": {
      "fourServices": "۴ یوځای شوي خدمتونه",
      "noMiddleman": "مستقیمه اړیکه",
  ...
  "vip": {
    ...
    "upsell": {
      ...
      "dailyLimitMessage": "تاسو نن ورځ د ۲ وړیا اعلانونو حد ته ورسیدئ. د نامحدود اعلان لپاره VIP غړی شئ.",
      "button": "د VIP غړیتوب"
    },
