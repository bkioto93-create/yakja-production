...
export default {
  ...
  "home": {
    ...
    "trustBadges": {
      "fourServices": "په یوه اپ کې نامحدود خدمتونه",
    ...
    "features": {
      ...
      "item1Title": "ټول خدمتونه، یوه اپ",
      "item1Desc": "له پېر او پلور او لیږد څخه تر فني خدمتونو او ملکیتونو پورې؛ ستا ټولې ورځنۍ اړتیاوې په یوه واحد پلیټ فارم کې.",
