...
export default {
  ...
  "home": {
    ...
    "slogan": "پیرودل، پلورل، موټر چلوونکی، متخصص او ملکیت؛ هر څه یو ځای، یوازې په څو لمسونو کې",
    "trustBadges": {
    ...
    "appDownload": {
      ...
      "subtitle": "ډېر ژر به له ګوګل پلی څخه ډاونلوډ کیدونکی وي. اوس مهال کولی شې همدا ویب اپ مستقیم د براوزر څخه نصب کړې.",
      "androidButton": "له ګوګل پلی څخه ډاونلوډ کړئ",
  ...
  "footer": {
    ...
    "androidComingSoon": "ډېر ژر په ګوګل پلی کې",
    "madeInAfghanistan": "په افغانستان کې جوړ شوی، د افغانستان لپاره"
  },
  "auth": {
    "login": {
      "title": "یکجا ته ننوتل",
